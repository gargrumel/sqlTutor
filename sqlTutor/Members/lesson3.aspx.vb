...
Public Class lesson3
    ...
    Dim lesson As Integer = 10 'Variable for the lesson ID for this page
    ...
    Public Sub finish()
        ...
        If complete = False Then 'Checks the complete variable value and if the lesson is not found in the complete table..
            ...
            r.updateQp(userId, 100) 'Calls the updateQp Method in the record class and passes the userId and qp value
        End If
