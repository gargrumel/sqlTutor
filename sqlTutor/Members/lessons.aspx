...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="tile"><a href="#">STAGE 1</a><br />
        ...
        <div class="tile"><a href="#">STAGE 6</a><br />
            <br />
            <asp:ImageButton ID="imgLess5" runat="server" ImageUrl="~/Images/locked-icon.png" height="74px" width="96px" />
            <br />
            <br />
        ...
        <div class="tile"><a href="#">STAGE 7</a><br />
            <br />
            <asp:ImageButton ID="imgLess6" runat="server" ImageUrl="~/Images/locked-icon.png" height="74px" width="96px" />
            <br />
            <br />
        ...
        <div class="tile"><a href="#">STAGE 8</a><br />
            <br />
            <asp:ImageButton ID="imgLess7" runat="server" ImageUrl="~/Images/locked-icon.png" height="74px" width="96px" />
            <br />
            <br />
        ...
        <div class="tile"><a href="#">STAGE 9</a><br />
            <br />
            <asp:ImageButton ID="imgLess8" runat="server" ImageUrl="~/Images/locked-icon.png" height="74px" width="96px" />
            <br />
            <br />
        ...
        <div class="tile"><a href="#">STAGE 10</a><br />
            <br />
            <asp:ImageButton ID="imgLess9" runat="server" ImageUrl="~/Images/locked-icon.png" height="74px" width="96px" />
            <br />
            <br />
