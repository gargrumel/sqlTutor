    ...
    <asp:Panel ID="Panel1" runat="server">
        ...
        <div class="docItem">
            <div class="lessonHeader">
                <asp:Label ID="Label2" runat="server" Text="LEVEL 3: SELECT ALL STATEMENT (WHERE Clause)- Reward: 30qp" Font-Size="Larger" Font-Bold="True"></asp:Label>
                 <br />
                    ...
                    <fieldset>
                        <asp:Panel ID="Panel3" runat="server">
                            ...
                            <asp:Panel ID="panelInstructions" runat="server" BackColor="#354551" ForeColor="White">
                                <asp:Label ID="lbScenario" runat="server" Text="To SELECT a specific record FROM a table"></asp:Label>
                                <br />
                                <br />
                    ...
                    <fieldset>
                        <div id="message">
                            <asp:Panel ID="panLess1" runat="server" Visible="False">
                                <table style="width: 25%; height: 100%">
                                    <tr>
                            ...
                            <br />
                            <asp:Panel ID="panLess2" runat="server" Visible="False" style="margin-bottom: 1px">
                                <table style="width: 25%; height: 100%">
                                    <tr>
